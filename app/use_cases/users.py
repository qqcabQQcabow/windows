...
from ..infrastructure.data_schemas import LoginInfo, RoleEnum, DriverRegistrInfo, LogistRegistrInfo
...
def registr_logits(data: LogistRegistrInfo) -> Optional[str]:
    ...
    try:
        ...
        db_users.add_logist(data, hash_p.decode('utf-8'), salt_p.decode('utf-8'))
